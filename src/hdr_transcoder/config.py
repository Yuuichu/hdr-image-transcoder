...
LIBULTRAHDR_DIR = TOOLS_DIR / "libultrahdr"
...
ULTRAHDR_DECODE_PEAK_TOLERANCE_STOPS = 0.15
DISPLAY_DECODE_PEAK_TOLERANCE_STOPS = 0.05
JXL_MASTER_PEAK_TOLERANCE_SCRGB = 0.02
DISPLAY_PEAK_TOLERANCE_SCRGB = 0.12

ULTRAHDR_BACKEND_AUTO = "auto"
ULTRAHDR_BACKEND_LIBULTRAHDR = "libultrahdr"
ULTRAHDR_BACKEND_IMAGECODECS = "imagecodecs"
ULTRAHDR_BACKENDS = {
    ULTRAHDR_BACKEND_AUTO,
    ULTRAHDR_BACKEND_LIBULTRAHDR,
    ULTRAHDR_BACKEND_IMAGECODECS,
}
ULTRAHDR_PROFILE_APPLE_P3 = "apple-p3"
ULTRAHDR_PROFILES = {ULTRAHDR_PROFILE_APPLE_P3}
ULTRAHDR_DEFAULT_GAINMAP_SCALE = 2
ULTRAHDR_DEFAULT_GAINMAP_GAMMA = 1.0
ULTRAHDR_DEFAULT_TARGET_PEAK_NITS = 1000.0
